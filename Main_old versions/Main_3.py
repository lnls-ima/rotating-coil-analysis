...
FORMATO ANTIGO E VERSÃO PORTUGUÊS
'''
        ...
        try:
            ...
            for i in range(n):
                ...
                if n_ima_str != 'Q' and n_ima_str != 'S':
                    self.n_ima_str_type_SI=self.Data[i].Mag_name[0]+self.Data[i].Mag_name[1]+self.Data[i].Mag_name[2] # in case of SI_Quadrupole: Q14, Q20, Q30 #ACRESCENTADO#
