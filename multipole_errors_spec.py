...
def _get_multipole_errors_spec():
    ...
    _dict['normal_rms_multipoles']  = _np.array([7,4,4,4,4,4,4,4,4])*1e-4
    _dict['skew_sys_monomials']     = _np.array([])
    _dict['skew_sys_multipoles']    = _np.array([])
    ...
    _dict['normal_sys_multipoles']  = _np.array([-7.0e-5, -1.4e-4, -2.4e-3, +1.4e-3])
    _dict['normal_rms_monomials']   = _np.array([3,4,5,6,8,14])
    _dict['normal_rms_multipoles']  = _np.array([1.5,1.5,1.5,1.5,1.5,1.5])*1e-4
    _dict['skew_sys_monomials']     = _np.array([])
    _dict['skew_sys_multipoles']    = _np.array([])
    _dict['skew_rms_monomials']     = _np.array([3,4,5,6,8,14])
    _dict['skew_rms_multipoles']    = _np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5])*1e-4
    ...
    _dict['normal_sys_multipoles']  = _np.array([-3.9e-4, 1.7e-3, -8.0e-4, +8.5e-5])
    _dict['normal_rms_monomials']   = _np.array([2,3,4,5,9,13,17])
    _dict['normal_rms_multipoles']  = _np.array([1.5,1.5,1.5,1.5,0,0,0])*1e-4
    _dict['skew_sys_monomials']     = _np.array([])
    _dict['skew_sys_multipoles']    = _np.array([])
    _dict['skew_rms_monomials']     = _np.array([2,3,4,5,9,13,17])
    _dict['skew_rms_multipoles']    = _np.array([0.5, 0.5, 0.5, 0.5, 0, 0, 0])*1e-4
    ...
    _dict['main'] = 1
    _dict['normal_sys_monomials']   = _np.array([5,9,13,17])
    _dict['normal_sys_multipoles']  = _np.array([-4.1e-4, 1.7e-3, -7.7e-4, +5.9e-5])
    _dict['normal_rms_monomials']   = _np.array([2,3,4,5,9,13,17])
    _dict['normal_rms_multipoles']  = _np.array([1.5,1.5,1.5,1.5,1.5,1.5,1,5])*1e-4
    _dict['skew_sys_monomials']     = _np.array([])
    _dict['skew_sys_multipoles']    = _np.array([])
    _dict['skew_rms_monomials']     = _np.array([2,3,4,5,9,13,17])
    _dict['skew_rms_multipoles']    = _np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5])*1e-4
    ...
    _dict['main'] = 1
    _dict['normal_sys_monomials']   = _np.array([5,9,13,17])
    _dict['normal_sys_multipoles']  = _np.array([-4.3e-4, 1.8e-3, -8.1e-4, +7.2e-5])
    _dict['normal_rms_monomials']   = _np.array([2,3,4,5,9,13,17])
    _dict['normal_rms_multipoles']  = _np.array([1.5,1.5,1.5,1.5,1.5,1.5,1,5])*1e-4
    _dict['skew_sys_monomials']     = _np.array([])
    _dict['skew_sys_multipoles']    = _np.array([])
...
def _residual_field(r0, x, n, sys_monomials, sys_relative_multipoles_at_r0, rms_monomials, rms_relative_multipoles_at_r0):
    ...
    for i in range (len(sys_monomials)):
        sys_residue = sys_residue + 1*sys_relative_multipoles_at_r0[i]*(x/r0)**(sys_monomials[i]-n)
    ...
    for j in range (nr_samples):
        ...
        for i in range (len(rms_monomials)):
            rms_residue = rms_residue + 1*rnd_relative_rms[i]*(x/r0)**(rms_monomials[i]-n)
...
def normal_residual_field(r0, x, magnet_name):
    ...
    if multipole_errors is None:
        ...
        sys_residue, max_residue, min_residue = _residual_field(r0, x, n, normal_sys_monomials, normal_sys_multipoles,
...
def skew_residual_field(r0, x, magnet_name):
    ...
    if multipole_errors is None:
        ...
        sys_residue, max_residue, min_residue = _residual_field(r0, x, n, skew_sys_monomials, skew_sys_multipoles,
